...
const socials = [
  { icon: <FaInstagram />, link: "https://www.instagram.com/loay_ze/"},
  { icon: <FaLinkedinIn />, link: "https://www.linkedin.com/in/loay-zeid-48b53a281/" },
  { icon: <FaGithub />, link: "https://github.com/Loay-zeid" },
];
      ...
      >
        ...
        <motion.div variants={variants}>
          <p className="text-lg font-light">
            ...
            collaboration, or how good the weather is . I'd love to hear from you.
          </p>
        </motion.div>
        ...
        <motion.div variants={variants}>
          <p className="text-lg font-light">Or call me @ +963 943 930 285</p>
        </motion.div>
      </motion.div>

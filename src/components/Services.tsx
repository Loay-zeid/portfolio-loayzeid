    ...
    >
      ...
      >
        ...
        >
          ...
          <p>
            Mixing visual creativity with structured logic , And delivering
            scalable web applications that bring ideas to life. My expertise
            covers modern frameworks like React, Next.js, and TypeScript,
            ensuring high performance and seamless user experiences with responsiveness to craft adaptable and fluid UI.
          </p>
        </motion.div>
        ...
        >
          ...
          <p>
            Partnering with businesses to turn ideas into real products. I conduct feasibility studies, define project requirements, and guide teams from concept to launch — not just execution, but co-building the vision and driving the project toward real impact
          </p>
        </motion.div>
